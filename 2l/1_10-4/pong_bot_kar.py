...
if resume:
  model = pickle.load(open('pong_bot_kar.p', 'rb'))
else:
  model = {}
...
while True:
  ...
  if done: # an episode finished
    ...
    if episode_number % batch_size == 0:
      ...
      pickle.dump(model, open('pong_bot_kar.p', 'wb'))
  ...
  #  reward_sum = 0
    ...
    open('pong_bot_kar.csv', 'at').write(str(episode_number) + ',' + str(reward_sum) + ',' + str(running_reward) + '\n'); reward_sum = 0
